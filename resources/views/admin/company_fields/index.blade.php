    ...
    <div class="page-container my-4">
        ...
        <div class="col-12 d-flex flex-wrap justify-content-between align-items-center my-3">
            <div class="col-12 col-md-8 mb-2 mb-md-0">
                <h4 class="header-title">{{__('lang.company_fields')}}</h4>
            </div>
            <div class="col-12 col-md-4 text-md-end text-center">
                ...
                <a class="badge badge-outline-primary" href="{{url(route('admin.company_fields.create'))}}">
                                {{__('lang.add_new')}} </a>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <div class="card bg-search">
                    <form action="{{route('admin.company_fields.index')}}" method="get" class="card-body pb-3" >
                        @csrf
                        <div class="row ">
                            ...
                            <div class="col-md-3">
                                <input class="form-control" type="text" name="search"
                                       placeholder="{{__('lang.name')}}" value="{{request()->get('search')}}">
                            </div>
                            ...
                            @forelse($companyFields as $item)
                                <tr>
                                    ...
                                    <td class="td_actions">                       @if(checkModulePermission('admins', 'edit'))
                                            <a href="{{url(route('admin.company_fields.edit' , $item->id))}}"
                                        ...
                                        @if(checkModulePermission('admins', 'delete'))
                                            <form action="{{route('admin.company_fields.destroy' , $item->id)}}" method="post"
                                            >
                                                @csrf
                                                @method('DELETE')
