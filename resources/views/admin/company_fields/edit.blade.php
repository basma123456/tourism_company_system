...
@section('content')
    ...
    <div class="page-container">
        ...
        <div class="col-12 d-flex justify-content-between align-items-center my-3">
            <div class="col-md-8">
                <h4 class="header-title">{{__('lang.company_field_edit')}} {{$companyField->name}}</h4>
            </div>
        ...
        <div class="col-lg-12"> @if (session('success'))
            ...
            <form action="{{route('admin.company_fields.update' , $companyField->id)}}" class="card" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" name="name" value="{{ $companyField->name }}"
                        ...
                        <div class="col-md-4">
                            <label for="active" class="col-form-label">{{__('lang.active')}}</label>
                                <input type="checkbox" name="active" {{$companyField->active == 1 ? 'checked' : ''}} value="1"
                                       id="active"
                                >
