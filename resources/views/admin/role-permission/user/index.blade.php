...
<div class="col-4 col-md-4 text-md-end text-center">
        ...
        </a> @if(checkModulePermission('admins', 'add')) <a href="{{ url(route('admin.users.create')) }}" class="btn btn-sm btn-primary min-w-180 float-end me-0 me-md-1   ">
            ...
            <table {{--  id="datatable-buttons"--}} class="table table-striped dt-responsive nowrap w-100">
              ...
              <tbody> @foreach ($users as $key => $user) <tr>
                  ...
                  <a href="{{ url(route('admin.users.edit',$user->id)) }}" class="btn btn-soft-success btn-icon btn-sm rounded-circle">
                    ...
                    @endif
                    @if(checkModulePermission('admins', 'delete')) <span onclick="confirmDeletion(this)" data-attr="{{ url(route('admin.users.delete',$user->id)) }}" class="btn btn-soft-success btn-icon btn-sm rounded-circle">
