        ...
        <div class="row">
            ...
            <div class="col-12 d-flex justify-content-between align-items-center my-3">
                ...
                <div>
                    ...
                    <div class="buttons">
                        @if(checkModulePermission('admins', 'add_role'))
                                ...
                                @foreach ($roles as $key => $role)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{--                                            </a>--}}
                                            @if(checkModulePermission('admins', 'roles_perm'))
                                            ...
                                            @if($role->id>2)
                                                @if(checkModulePermission('admins', 'edit_role'))
                                                ...
                                                @if(checkModulePermission('admins', 'delete_role'))
