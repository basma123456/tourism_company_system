                    ...
                    <form action="{{route('admin.settings.update')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        @if($setting)
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <div class="row">
                                        ...
                                        <img src="{{asset($setting->logo)}}" style="width: 100px;" class="     rounded " >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <label for="{{$setting->company_name_ar}}" class="col-3 col-form-label">{{__('lang.company_name')}} AR</label>
                                <div class="col-9">
                                    <div class="row">
                                        <input type="text" name="company_name_ar"  value="{{$setting->company_name_ar}}"
