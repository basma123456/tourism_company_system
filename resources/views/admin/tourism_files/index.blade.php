    ...
    <div class="page-container my-4">
        ...
        <div class="col-12 d-flex flex-wrap justify-content-between align-items-center my-3">
            <div class="col-12 col-md-8 mb-2 mb-md-0">
                <h4 class="header-title">{{__('lang.tourism_files')}}</h4>
            </div>
            <div class="col-12 col-md-4 text-md-end text-center">
                ...
                <div class="">
                    ...
                    <a class="badge badge-outline-primary" href="{{url(route('admin.tourism_files.create'))}}">
                        {{__('lang.add_new')}} </a>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <div class="card bg-search">
                    <form action="{{route('admin.tourism_files.index')}}" method="get" class="card-body pb-3">
                        @csrf
                        <div class="row ">
                            ...
                            <div class="col-md-3">
                                <input class="form-control" type="date" name="date"
                                       placeholder="{{__('lang.date')}}" value="{{request()->get('date')}}">
                            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            @forelse($tourismFiles as $item)
                                <tr>
                                    ...
                                    <td>@if($item->closed == 1) <i class="fa fa-check text-success"></i> @else  <i
                                            class="fa fa-minus text-secondary"></i>   @endif</td>
                                    <td>@if($item->approved == 1) <i class="fa fa-check text-success"></i> @else  <i
                                            class="fa fa-minus text-secondary"></i>   @endif</td>


                                    <td class="td_actions">                       @if(checkModulePermission('admins', 'edit'))
                                            <a href="{{url(route('admin.tourism_files.edit' , $item->id))}}"
                                        ...
                                        @if(checkModulePermission('admins', 'delete'))
                                            <form action="{{route('admin.tourism_files.destroy' , $item->id)}}"
                                                  method="post"
                                            >
                                                @csrf
                                                @method('DELETE')
