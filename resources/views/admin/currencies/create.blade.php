    ...
    <div class="page-container">
        ...
        <div class="col-12 d-flex flex-wrap justify-content-between align-items-center my-3">
            <div class="col-8 col-md-8 mb-2 mb-md-0">
                <h4 class="header-title">{{__('lang.add_currency')}}</h4>
            </div>
            <div class="col-4 col-md-4 text-center text-md-end">
                <a href="{{ url(route('admin.currencies.index')) }}" class="btn btn-soft-info rounded-pill  float-end"><i class="ri-arrow-go-back-line"></i><span class="d-none d-sm-inline"> &nbsp;&nbsp;{{__('lang.Back')}}   </span></a>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="card">
...
{{--                    <br>--}}
{{--                    @endif--}}
                    <form action="{{ url(route('admin.currencies.store')) }}" method="POST" class="form-horizontal"> @csrf
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <label for="rate" class="col-3 col-form-label">{{__('lang.rate')}}</label>
                                <div class="col-12">
