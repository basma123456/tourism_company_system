    ...
    <div class="page-container my-4">
        ...
        <div class="col-12 d-flex flex-wrap justify-content-between align-items-center my-3">
            <div class="col-12 col-md-8 mb-2 mb-md-0">
                <h4 class="header-title">{{__('lang.currencies')}}</h4>
            </div>
            <div class="col-12 col-md-4 text-md-end text-center">
                ...
                <a class="badge badge-outline-primary" href="{{url(route('admin.currencies.create'))}}">
                                {{__('lang.add_new')}} </a>


                    {{--/**********excel btn**********/--}}
                    <span title="اكسيل" onclick="getDataExcel('{{url('/admin/currencies_all')}}', 'currencies.xlsx')"
                          target="_blank"
                    ...
                    <span title="طباعة" onclick="getDataPrint('{{url('/admin/currencies_all')}}')" class="btn btn-sm btn-danger  ">
        ...
        <div class="card shadow-sm border-0">
                            ...
                            @forelse($currencies as $item)
                                <tr>
                                    ...
                                    <td class="td_actions">                       @if(checkModulePermission('admins', 'edit'))
                                            <a href="{{url(route('admin.currencies.edit' , $item->id))}}"
                                        ...
                                        @if(checkModulePermission('admins', 'delete'))
                                            <form action="{{route('admin.currencies.destroy' , $item->id)}}" method="post"
                                            >
                                                @csrf
                                                @method('DELETE')
            ...
            <div class="mt-4 d-flex justify-content-center">
                ...
                {{count($currencies) ? $currencies->links() : ''}}
            </div>

            <!---------------------start print all grid ------------>
            <div id="pr" style="display: none">
                @include('admin.currencies.print', ['currencies'=>@$currencies])
            </div>
            <!-----end all grid ------------->
