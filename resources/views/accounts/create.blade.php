        ...
        <div class="row">
            ...
            <div class="col-xl-12 m-auto">
                <div class="card m-auto">
                    ...
                    <div class="card-body">
                        <form action="{{ url(route('admin.acc_store')) }}" method="POST" class="form-horizontal "
                              novalidate
                            ...
                            @if (session('error'))
                                ...
                                <div class="col-lg-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="simpleinput" name="code" value=""
